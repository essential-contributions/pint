...
impl AsmBuilder<'_> {
    ...
    fn compile_external_intrinsic_call(
        ...
        if let ExternalIntrinsic::SiblingPredicateAddress = kind {
            ...
            c_asm.push(match kind {
                ...
                ExternalIntrinsic::StateLen | ExternalIntrinsic::SiblingPredicateAddress => {
                    unreachable!("StateLen is handled above")
                }
