...
predicate Foo() {
    ...
    let x_post = Extern1@[0x1233683A8F6B8AF1707FF76F40FC5EE714872F88FAEBB8F22851E93F56770128]::storage::x';
    ...
    let w_post = Extern2@[0x0C15A3534349FC710174299BA8F0347284955B35A28C01CF45A910495FA1EF2D]::storage::w';
